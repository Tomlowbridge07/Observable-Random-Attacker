...
\begin{note}
In the case of $i=j$: 
If $x_{j} > 1$ then our function becomes $c_{j} \lambda_{j} (R_{j}-1) + c_{j} v_{j}$.
If $x_{j} \leq 1$ then our function becomes $c_{j} \lambda_{j} (R_{j}-x_{j}) + c_{j} v_{j}$
\end{note}
...
\begin{note}
In the case of $i=j$: 
If $x_{j} > 1$ then our function becomes $0$.
If $x_{j} \leq 1$ then our function becomes $c_{j} \lambda_{j} (1-x_{j})$
\end{note}
...
\frac{s_{i} \widetilde{\Delta_{i}}}{B_{i}} \text{ If } s \leq B,v_{i} \geq v_{i,\text{max}} \\
\widetilde{\Delta_{i}} \text{ If } s_{i}=B_{i}+1
\end{cases}
\end{align}
...
\frac{\widetilde{\Delta_{i}}}{B+1-s_{i}} \text{ If } s \leq B,v_{i} \geq v_{i,\text{max}} \\
\widetilde{\Delta_{i}} \text{ If } s_{i}=B_{i}+1
\end{cases}
\end{align}
